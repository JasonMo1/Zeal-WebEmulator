...
(() => {
    ...
    var n,
        ...
        g = "not_object",
        _ = "Db_blocked",
        w = "indexeddb_not_supported",
        x = "null_value_in_where",
        k = "invalid_join_query",
        T = "import_scripts_failed",
        S = "method_not_exist",
        E = "invalid_middleware";
    (function (e) {
    ...
    var O,
                ...
                (e.prototype.setColumn = function (e) {
                    var t = [],
                        n = function (n) {
                            ...
                            (o.name = n),
                                o.autoIncrement &&
                                    (r.autoIncColumnValue[n] = 0),
                                o.primaryKey && (r.primaryKey = n),
                                (o.enableSearch =
                                    null == o.enableSearch || o.enableSearch);
        ...
        C = (function () {
            ...
            return (
                ...
                (e.set = function (t, n, r) {
                    r.tx || r.createTransaction([e.tableName]);
                    var o = r.objectStore(e.tableName);
                ...
                (e.get = function (t, n) {
                    n.tx || n.createTransaction([e.tableName]);
                    var r = n.objectStore(e.tableName);
                ...
                (e.prototype.getMsg_ = function () {
                    var e,
                        ...
                        r =
                            ...
                            (e.no_value_supplied = function () {
                                t = "No value is supplied";
                            }),
                            (e.invalid_operator = function () {
                                t = "Invalid Op Value '" + n.Op + "'";
                            }),
                            (e.column_not_exist = function () {
                                var e = n.column;
                                t = n.isOrder
                                    ? "Column '".concat(
                                          e,
                            ...
                            (e.db_not_exist = function () {
                                t = "Database with name ".concat(
                                    n.dbName,
                                    " does not exist",
                                );
                            }),
                            (e.not_object = function () {
                                t = "supplied value is not object";
                            }),
                            (e.invalid_operator = function () {
                                t = "Invalid Config '" + n.Config + " '";
                            }),
                            (e.Db_blocked = function () {
                                t =
                                    "database is blocked, cant be deleted right now";
                            }),
                            (e.null_value_in_where = function () {
                                t =
                                    "Null/undefined is not allowed in where. Column '".concat(
                                        n.column,
                                        "' has null",
                                    );
                            }),
                            (e.method_not_exist = function () {
                                t = "method '".concat(n, "' does not exist.");
                            }),
                            (e.indexeddb_not_supported = function () {
                                t = "Browser does not support indexeddb";
                            }),
                            (e.getInfo = function () {
                                t = n;
                            }),
                            (e.invalid_join_query = function () {
                                r.getInfo();
                            }),
                            (e.import_scripts_failed = function () {
                                r.getInfo();
                            }),
                            (e.invalid_middleware = function () {
                        ...
                        (a.onsuccess = function () {
                            ...
                            (a.onupgradeneeded = function (n) {
                                ...
                                var a = u.transaction,
                                    ...
                                    l = function (e, t, n) {
                                        var r = t.columns.findIndex(
                                            function (e) {
                                                return e.name === n;
                                            },
                                        );
                                        r >= 0 &&
                                            (t.columns.splice(r, 1),
                                            e.deleteIndex(n));
                                    };
        ...
        L = function (e) {
            if (e instanceof I) return e.logError(), e.get();
            var t = void 0;
            return (
                e.name
                    ? ((t = new I(e.name)).message = e.message)
                    : ((t = new I(e.target.error.name)).message =
        ...
        B = (function () {
            ...
            return (
                ...
                (e.prototype.checkNotNullAndDataType_ = function (e, t) {
                    return e.notNull && V(t[e.name])
                        ? this.getError(v, { ColumnName: e.name })
                        : e.dataType &&
                          !V(t[e.name]) &&
                          W(t[e.name]) !== e.dataType
                        ? this.getError(m, { column: e.name })
                        : void 0;
                }),
                (e.prototype.checkAndModifyColumnValue_ = function (e, t) {
                    ...
                    if (
                        (e.autoIncrement
                            ? V(n)
                                ? (t[e.name] = ++this.autoIncrementValue[
                                      e.name
                                  ])
                                : W(n) === r.Number &&
        ...
        P = (function () {
            ...
            return (
                ...
                (e.prototype.checkByColumn_ = function (e, t) {
                    if (!0 === e.notNull && V(t))
                        return new I(v, { ColumnName: e.name });
                    var n = W(t),
                        r = null != t;
                    if (e.dataType && r && n !== e.dataType && "object" !== n)
                        return new I(m, { column: e.name });
                    if (r && "object" === n) {
                        var o = ["+", "-", "*", "/", "{push}"];
                        for (var u in t)
                            if (
        ...
        M = (function () {
            ...
            return (
                ...
                (e.prototype.isInsertQryValid = function (e) {
                    ...
                    else t = new I(b, { tableName: e.into });
                    return { table: n, log: t };
                }),
                (e.prototype.checkUpdate = function (e) {
                    var t = new P(this.getTable_(e.in)).check(e.set, e.in);
                    if (t) return t;
                    if (null != e.where) {
                ...
                (e.prototype.checkSelect = function (e) {
                    if (!e.store && !this.getTable_(e.from))
                        return new I(b, { tableName: e.from });
                    if (e.where) {
                ...
                (e.prototype.checkForNullInWhere_ = function (e) {
                    for (var t in e.where)
                        if (null == e.where[t]) return new I(x, { column: t });
                }),
                ...
                (e.prototype.checkInsertQuery = function (e) {
                    ...
                    if (!e.skipDataCheck) {
                        var o = new B(
                                n,
                                n.autoIncColumnValue,
                            ).checkAndModifyValues(e),
                            u = o.values,
                            i = o.err;
                        return (e.values = u), i;
                    }
        ...
        G = (function (e) {
            ...
            return (
                ...
                (t.prototype.execute = function (e) {
                    var t = this,
                        n = this.db,
                        r = new M(n).validate(o.Insert, this.query);
                    return r
                        ? N(r)
                        : e()
                              .then(function (e) {
                                  return t.insertData_(n).then(function (e) {
                                      return t.query.return
                                          ? t.valuesAffected_
                                          : t.rowAffected;
                                  });
                              })
                    ...
                    return (
                        ...
                        (n =
                            u.ignore && !o.isTxQuery
                                ...
                                : (o.isTxQuery ||
                                      o.util.createTransaction([
                                          u.into,
                                          C.tableName,
                                      ]),
                                  (o.objectStore = o.util.objectStore(
                                      o.tableName,
                                  )),
                                  function (e) {
            ...
            return (
                ...
                (e.prototype.checkCase_ = function (e) {
                    ...
                    for (t in e) {
                        switch (t) {
                            case i.GreaterThan:
                                if (this.value[this.columnName_] > e[t])
                                    return !0;
                                break;
                            case i.Equal:
                                if (this.value[this.columnName_] === e[t])
            ...
            return function (r) {
                ...
                o
                    ? n && t.results.length !== t.limitRecord
                        ? (t.shouldAddValue(o) && t.pushResult(o.value),
                          o.continue())
        ...
        te = function (e) {
            ...
            return function (n) {
                ...
                r && t.results.length !== t.limitRecord
                    ? (t.shouldAddValue(r) && t.pushResult(r.value),
                      r.continue())
                    : e();
            };
        },
        ...
        ce = function (e) {
            ...
            if (null == t) {
                ...
                if (o) return { dataType: W(o), name: e };
                throw new I(y, { column: e, isOrder: !0 });
            }
            return t;
        },
        se = function (e, t) {
        ...
        me = function (e, t) {
            switch (e.dataType) {
                case r.String:
                    return "asc" === t.type ? le : se;
                case r.Number:
                    return "asc" === t.type ? ye : pe;
                case r.DateTime:
                    return "asc" === t.type ? ve : de;
                default:
                    return "asc" === t.type ? he : fe;
            }
        },
        be = function (e) {
            var t;
                    ...
                    i = function (e, t) {
                        return function (n, i) {
                            for (var a in u) {
                                ...
                                return typeof n[c] === r.String
                                    ? e(n[c], i[s])
                                    : t(n[c], i[s]);
                            }
                        };
                    },
                    a = "asc" === e.type ? i(le, ye) : i(se, pe);
                this.results.sort(a);
            } else {
                var c = ce.call(this, n);
                if (null != c) {
                    var s = me(c, e);
                    (n = c.name),
                        null == e.case
                            ...
                            : (o.setCaseAndColumn(
                              ...
                              this.results.sort(function (e, t) {
                                  return s(
                                      o.setValue(e).evaluate(),
                                      o.setValue(t).evaluate(),
                                  );
                              }));
                }
            }
        ...
        we = function (e) {
            return "object" === W(e) && !(e instanceof RegExp);
        },
        xe = function (e) {
            if (we(e)) {
                var t = {};
                for (var n in e)
                    t[n] = null != e[n] && we(e[n]) ? xe(e[n]) : e[n];
                return t;
            }
            return e;
        },
        ke = function (e, t, n) {
            ...
            if (o !== W(t)) return !1;
            switch (
                (o === r.DateTime && ((e = e.getTime()), (t = t.getTime())), n)
            ) {
                case i.GreaterThan:
                    return e > t;
                case i.LessThan:
        ...
        Te = (function () {
            function e(e, t) {
                (this.where = xe(e)), (this.checkFlag = t);
            }
            return (
                ...
                (e.prototype.checkLike_ = function (e, t) {
                    return _e(this.where[e][i.Like]).test(t);
                }),
            ...
            return (
                ...
                (t.prototype.goToWhereLogic = function () {
                    var e = this,
                        ...
                        r = (function () {
                            for (var t in n)
                                if (e.objectStore.indexNames.contains(t))
                                    return t;
                        })();
                    if (null == r && ((r = H(n)), !t.store))
                        return N(new I(d, { column: r }));
                    var o = n[r];
                    if ("object" !== W(o))
                        return (
                            (u = $(n) > 1),
                            (this.whereChecker = new Te(n, u)),
            ...
            return (
                ...
                (e.prototype.execute = function () {
                    var e = this,
                        t = this.query;
                    this.joinQueryStack_ =
                        W(t.join) === r.Object ? [t.join] : t.join;
                    var n = t.from,
                        o = [];
                    n && o.push(n);
                    for (
                        var u = this.joinQueryStack_, i = 0, a = u.length;
                        i < a;
                        i++
                    ) {
                        var c = u[i],
                    ...
                    if (f && !t.store) {
                                ...
                                if (Array.isArray(e))
                                    (t = []),
                                        (e = e.filter(function (e) {
                                            var n = p(e);
                                            return (
                                                Object.keys(n.whereQryAfterJoin)
                                                    .length > 0 &&
                        ...
                        (t.where = y.whereQueryModified),
                            y.isWhereEmpty && delete t.where;
                    ...
                    return this.executeSelect({
                        ...
                        return (
                            (e.results = t.map(function (t) {
                                var n;
                                return (
                                    ((n = {})[e.currentQueryStackIndex_] = t), n
                                );
                            })),
                            e.tablesFetched.push(
                                u[0].joinTableInfo.table1.table,
                            ),
                    ...
                    "left" === a
                        ? ((i = {}),
                          e.store
                              ...
                              : this.getTable(t.table2.table).columns.forEach(
                                    function (e) {
                                        i[e.name] = null;
                                    },
                                ),
        ...
        Ne = (function (e) {
                    ...
                    (r.returnResult_ = function () {
                        if (r.results.length > 0) {
                            ...
                            r.processGroupDistinctAggr(),
                                ...
                                r.limitAtEnd &&
                                    (r.results = r.results.slice(0, e.limit));
                        }
                        return r.results;
                    }),
                    (r.query = t),
            ...
            return (
                ...
                (t.prototype.execute = function (e) {
                    ...
                    var n = this.query;
                    try {
                        var r = new M(this.db).validate(o.Select, n);
                        return r
                            ? N(r)
                            : e().then(function (e) {
                                  return (
                    ...
                    var n,
                        ...
                        f = function () {
                            var t = r.shift(),
                                o = t[i.Or];
                            if (o) {
                                if (U(o)) return (n = i.Or), s(o);
                                1 === $(t)
                                    ? ((n = i.Or), (t = o))
                                    : (n = i.And);
                            } else if (((n = i.And), U(t))) return s(t);
                            return (
                                (e.query.where = t), e.processWhere_().then(c)
                            );
                        };
                    return f();
                }),
                ...
                (t.prototype.orQuerySuccess_ = function () {
                    ...
                    this.results.length > 0 &&
                        (this.orInfo.results = Qe(
                            Qe([], this.orInfo.results, !0),
                            this.results,
                            !0,
                        )),
                        (this.results = []);
                    var t = H(this.orInfo.orQuery);
                    if (null != t) {
                        var n = {};
                        return (
    ...
    (Ne.prototype.executeInLogic = function (e, t) {
        var n = this,
            ...
            u = Y.call(this, ne, te, je, Oe);
        return Q(
            t.map(function (t) {
                return f(function (r, i) {
                    var a = n.objectStore
                        .index(e)
                        .openCursor(n.util.keyRange(t));
        ...
        (Ne.prototype.executeWhereUndefinedLogic = function () {
            ...
            if (o && !1 !== o.idbSorting && o.by) {
                if (!u.indexNames.contains(o.by))
                    return N(new I(y, { column: o.by, isOrder: !0 }));
                var i =
                    o.type && "desc" === o.type.toLowerCase() ? "prev" : "next";
                (this.sorted = !0), (e = u.index(o.by).openCursor(null, i));
            } else e = u.openCursor();
            var a = Y.call(this, ue, ie, oe, re);
        ...
        (Ne.prototype.executeWhereLogic = function (e, t, n, r) {
            ...
            var u = this.objectStore
                    .index(e)
                    .openCursor(this.util.keyRange(t, n), r),
                i = Y.call(this, ne, te, ee, Z);
        ...
        (Ne.prototype.executeAggregateGroupBy = function () {
            ...
            if (W(u) === r.String)
                for (e in a) (t = a[e][u]), l(), c.set(t, a[e]);
            else
                for (e in a) {
    ...
    var Le = function (e) {
            ...
            return function (n) {
                var r = n.target.result;
                r
                    ? (t.shouldAddValue(r) && ++t.resultCount, r.continue())
                    : e();
            };
        },
        De = (function () {
        ...
        We = (function (e) {
            ...
            return (
                        ...
                        : e().then(function (e) {
                              ...
                              try {
                                  ...
                                  t.initTransaction_(),
                                      null == r.join
                                          ? null != r.where
                                              ? r.where.or || U(r.where)
                                                  ? (n = o())
                                                  : ((t.shouldAddValue =
                                                        function (e) {
                                                            return t.whereChecker.check(
                                                                e.value,
                                                            );
                                                        }),
                                                    (n = t.goToWhereLogic()))
                ...
                (t.prototype.initTransaction_ = function () {
                    ...
                    this.isTxQuery ||
                        this.util.createTransaction([e], a.ReadOnly),
                        (this.objectStore = this.util.objectStore(e));
                }),
                t
            );
        })(Ee);
    (We.prototype.executeWhereUndefinedLogic = function () {
        var e,
            t,
            n = this,
            r = this.objectStore,
        ...
        (We.prototype.executeWhereLogic = function (e, t, n) {
            var r,
                o = this;
            t = n ? t[n] : t;
            var u = 1 === $(this.query.where),
                i = this.objectStore;
            return f(function (a, c) {
                u && i.count
                    ...
                    : ((r = i
                          .index(e)
                          .openCursor(o.util.keyRange(t, n))).onsuccess =
                          Le.call(o, a)),
                    (r.onerror = c);
            });
        }),
        (We.prototype.executeRegexLogic = function (e, t) {
            var n = this,
            ...
            return (
                ...
                f(function (e, t) {
                    (r.onerror = t), (r.onsuccess = Le.call(n, e));
                })
            );
        }),
        (We.prototype.executeInLogic = function (e, t) {
            var n = this,
                r = this.objectStore,
                o = r.index(e),
                u = 1 === $(this.query.where);
            return Q(
                t.map(function (e) {
                    return (
                        (t = e),
    ...
    var Ve = function (e) {
            return (U(e) ? e : e.split(".")).reduce(function (e, t) {
                return e && e[t];
            }, self);
        },
        Be = function (e, t) {
        ...
        Me = (function (e) {
            function t(t, n) {
                ...
                var u = t.mapSet;
                if (u) {
                    var i = W(u) === r.String ? Ve(u) : u;
                    if (!i) throw new I(S, u);
                    t.mapSet = i;
                }
                return o;
            }
            return (
                ...
                (t.prototype.execute = function (e) {
                    var t = this,
                        n = this.query;
                    try {
                        var r = new M(this.db).validate(o.Update, n);
                        return r
                            ? N(r)
                            : e().then(function (e) {
                                  return (
    ...
    (Me.prototype.executeWhereUndefinedLogic = function () {
        var e = this,
        ...
        return f(function (n, r) {
            (t.onsuccess = function (t) {
                ...
                if (o)
                    try {
                        var u = o.update(Be(e.query, o.value));
                        (u.onsuccess = function () {
        ...
        (Me.prototype.executeWhereLogic = function (e, t, n) {
            var r = this,
                o = this.query;
            t = n ? t[n] : t;
            var u = this.objectStore
                .index(e)
                .openCursor(this.util.keyRange(t, n));
            return f(function (e, t) {
        ...
        (Me.prototype.executeRegexLogic = function (e, t) {
            var n,
                r = this,
                    ...
                    (o.onsuccess = function (o) {
                        if ((n = o.target.result))
                            if (r.shouldAddValue(n))
                                try {
                                    var u = n.update(Be(r.query, n.value));
                                    (u.onsuccess = function () {
        ...
        (Me.prototype.executeInLogic = function (e, t) {
            var n = this,
    ...
    var Ke = (function () {
        ...
        $e = function (e) {
            ...
            return function (n) {
                var r = n.target.result;
                r
                    ? (t.shouldAddValue(r.value) &&
                          (r.delete(), ++t.rowAffected),
                      r.continue())
                    : e();
            };
        },
    ...
    (Xe.prototype.executeInLogic = function (e, t) {
        var n = this,
            r = this.objectStore.index(e);
        return Q(
            t.map(function (e) {
                return (
                    ...
                    f(function (e, o) {
                        ...
                        (u.onsuccess = $e.call(n, e)), (u.onerror = o);
                    })
                );
                var t;
            }),
        ...
        (Xe.prototype.executeWhereUndefinedLogic = function () {
            var e,
                t = this,
        ...
        (Xe.prototype.executeWhereLogic = function (e, t, n) {
            var r = this;
            t = n ? t[n] : t;
            var o = this.objectStore
                ...
                .openCursor(this.util.keyRange(t, n));
            return f(function (e, t) {
                (o.onsuccess = $e.call(r, e)), (o.onerror = t);
            });
        }),
        (Xe.prototype.executeRegexLogic = function (e, t) {
            var n,
                r = this,
                o = this.objectStore.index(e).openCursor();
            return (
        ...
        Ze = (function (e) {
            ...
            return (
                ...
                (t.prototype.execute = function (e) {
                    ...
                    return (
                        this.isTxQuery ||
                            this.util.createTransaction([n, C.tableName]),
                        e().then(function (e) {
                            ...
                            try {
                                return f(function (e, o) {
                                    (r.onsuccess = function (r) {
                                        ...
                                        C.set(C.dbSchema, t.util.db, t.util)
                                            .then(e)
                                            .catch(o);
                                    }),
                                        (r.onerror = o);
        ...
        tt = (function (e) {
            ...
            return (
                    ...
                    return n
                        ...
                        : (this.startExecution_(),
                          f(function (e, n) {
                              ...
                              return (
                                  (t.beforeExecute = null),
                                  t.log("transaction finished"),
                                  e
                              );
                          }));
                }),
                (t.prototype.validate = function () {
                    ...
                    if (t) return new I(b, { tableName: t });
                    var n = e.method;
                    return Ve(n) ? void 0 : new I(S, n);
                }),
        ...
        rt = (function () {
            ...
            return (
                ...
                (e.prototype.executeQuery = function (e, t) {
                    ...
                    return (
                        u.logger.log(
                            "Executing query ".concat(e.name, " in web worker"),
                        ),
                        n
                    );
                }),
                ...
                (e.prototype.initDb = function (e) {
                    var t = this;
                    if (!F) return N(new I(w));
                    var n = e ? new A(e) : this.db;
                    if (null == n) throw new Error("dbMeta is null");
                    return (
                        (this.util = new R()),
                        this.util.initDb(n).then(function (e) {
                            return C.get(C.dbSchema, t.util).then(function (r) {
                                return e.isCreated
                                    ? (r &&
                                          r.tables.forEach(function (e) {
                                              ...
                                              if (t)
                                                  for (var r in e.autoIncColumnValue) {
                                                      var o =
                                                          e.autoIncColumnValue[
                                                              r
                                                          ];
                                                      o &&
                                                          (t.autoIncColumnValue[
                                                              r
                                                          ] = o);
                                                  }
                                          }),
                                      (t.util.db = n),
                                      (e.database = nt(t.db)),
                                      C.set(C.dbSchema, n, t.util).then(
                                          function () {
                                              return e;
                                          },
                                      ))
                                    : C.get(C.dbSchema, t.util).then(
                                          function (n) {
                                              return (
                                                  (t.util.db = n),
                                                  (e.database = nt(t.db)),
