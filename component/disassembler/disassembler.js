...
function Disassembler() {
    const m_opcodes = {
        ...
        0x21: (snd, trd) => ({
            text: `LD     HL, ${hex16(trd, snd)}`,
            size: 3,
        }),
        0x22: (snd, trd) => ({
            text: `LD     (${hex16(trd, snd)}), HL`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        ...
        0x31: (snd, trd) => ({
            text: `LD     SP, ${hex16(trd, snd)}`,
            size: 3,
        }),
        0x32: (snd, trd) => ({
            text: `LD     (${hex16(trd, snd)}), A`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        ...
        0xc2: (snd, trd) => ({
            text: `JP     NZ, ${hex16(trd, snd)}`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        0xc3: (snd, trd) => ({
            text: `JP     ${hex16(trd, snd)}`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        0xc4: (snd, trd) => ({
            text: `CALL   NZ, ${hex16(trd, snd)}`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        ...
        0xca: (snd, trd) => ({
            text: `JP     Z, ${hex16(trd, snd)}`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        0xcc: (snd, trd) => ({
            text: `CALL   Z, ${hex16(trd, snd)}`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
        0xcd: (snd, trd) => ({
            text: `CALL   ${hex16(trd, snd)}`,
            size: 3,
            label: true,
            address: (trd << 8) | snd,
        }),
    ...
    function addrFromOpcodeEntry(pc, entry) {
        ...
        if (typeof entry.address !== "undefined") return entry.address;
