!(function (e, t) {
    "undefined" != typeof module
        ? ((module.exports = t()), (Z80ASM = module.exports))
    ...
    var e = {
        ...
        parseOpcode: function (t) {
            ...
            if (h) {
                    ...
                    if (1 == t.params.length) {
                        ...
                        if ("EX" == t.opcode)
                            return "DE" == C.toUpperCase() &&
                                "HL" == x.toUpperCase()
                                ? ((t.lens = [235]), (t.bytes = 1), t)
                                : "AF" == C.toUpperCase() &&
                                  "AF'" == x.toUpperCase()
                                ? ((t.lens = [8]), (t.bytes = 1), t)
                                : "(SP)" == C.toUpperCase() &&
                                  "HL" == x.toUpperCase()
                                ? ((t.lens = [227]), (t.bytes = 1), t)
                                : "(SP)" == C.toUpperCase() &&
                                  "IX" == x.toUpperCase()
                                ? ((t.lens = [221, 227]), (t.bytes = 2), t)
                                : "(SP)" == C.toUpperCase() &&
                                  "IY" == x.toUpperCase()
                                ? ((t.lens = [253, 227]), (t.bytes = 2), t)
                                : null;
                        if ("CALL" == t.opcode)
                            return (
                                (h = e.set2.CAL2),
                                (r = l(C)) >= 0 && h[5] > 0 && (c = h[5]) > 0
                                    ? ((c += r << 3),
                                      (t.bytes = 3),
                                      (t.lens = []),
                                      (t.lens[0] = c),
                        ...
                        "A" == C.toUpperCase() &&
                            ...
                            "IX" == C.toUpperCase() &&
                                (r = ["BC", "DE", "IX", "SP"].indexOf(
                                    x.toUpperCase(),
                                )) >= 0 &&
                                ((c = h[2] + (r << 4)), (g = 221)),
                            "IY" == C.toUpperCase() &&
                                (r = ["BC", "DE", "IY", "SP"].indexOf(
                                    x.toUpperCase(),
                                )) >= 0 &&
                                ((c = h[2] + (r << 4)), (g = 253)),
                            "HL" == C.toUpperCase() &&
                ...
                if (c < 0) throw "Bad addressing mode at line " + t.numline;
                return (
                    c > 255
                        ? (d++, (m[0] = (65280 & c) >> 8), (m[1] = 255 & c))
                        : (m[0] = 255 & c),
                    g && (m.unshift(g), d++),
                    null !== v &&
                        void 0 !== v &&
    ...
    (function (e, t) {
        "undefined" != typeof module
            ? ((module.exports = t()), (ASM = module.exports))
            : "function" == typeof define && "object" == typeof define.amd
            ? define(t)
            : (this.ASM = t());
    })(0, function () {
        ...
        var e = null,
            ...
            s = function (e) {
                return e.map(function (e) {
                    ...
                    if (((e.line = t), " " != t[0])) return e;
                    for (; " " == t[0]; ) t = t.substr(1);
                    return (e.line = " " + t), e;
                });
            },
            o = function (e) {
                return e.filter(function (e) {
                    for (var t = e.line; " " == t[0]; ) t = t.substr(1);
                    return !!t.length;
                });
            },
            i = function (e) {
            ...
            p = function (t, r, n, s) {
                ...
                if (
                    (a
                        ? ((t.opcode = a[1].toUpperCase()), (o = a[2]))
                        : (a = o.match(/^\s*([\.a-zA-Z0-9-_]+)\s*(.*)/)) &&
                          ((t.opcode = a[1].toUpperCase()), (o = a[2])),
                    o)
                ) {
                    for (; o.match(/"(.*?);(.*?)"/g); )
                ...
                if ("DEFB" === t.opcode) return (t.opcode = "DB"), t;
                if (".BYTE" === t.opcode) return (t.opcode = "DB"), t;
                if (".DB" === t.opcode) return (t.opcode = "DB"), t;
                if (".WORD" === t.opcode) return (t.opcode = "DW"), t;
                if (".DW" === t.opcode) return (t.opcode = "DW"), t;
                if ("DEFW" === t.opcode) return (t.opcode = "DW"), t;
                if ("DEFS" === t.opcode) return (t.opcode = "DS"), t;
                if (".RES" === t.opcode) return (t.opcode = "DS"), t;
                if ("DEFM" === t.opcode) return (t.opcode = "DS"), t;
                if (".ALIGN" === t.opcode) return (t.opcode = "ALIGN"), t;
                if (".IF" === t.opcode) return (t.opcode = "IF"), t;
                if (".ELSE" === t.opcode) return (t.opcode = "ELSE"), t;
                if (".ENDIF" === t.opcode) return (t.opcode = "ENDIF"), t;
                if (
                    "EQU" === t.opcode ||
                    "=" === t.opcode ||
                    "IF" === t.opcode ||
                ...
                if (null !== b) return b;
                if (r[t.opcode]) return (t.macro = t.opcode), t;
                if (!t.label && !n) {
                    var C = {
                        line: t.line,
                        numline: t.numline,
                    ...
                    0 === t.params[0].indexOf(":=") &&
                        (t.params[0] = t.params[0].substr(1)),
            ...
            u = function (e, n) {
                ...
                n = n || {};
                for (
                    var f = {}, c = null, d = null, m = [], g = 0, v = e.length;
                    g < v;
                    g++
                )
                        ...
                        if (
                            ...
                            if (".INCLUDE" !== b)
                                ...
                                if (r[h[0].replace(/\"/g, "")])
                                    throw {
                                        msg:
                                            "File " +
                                            h[0].replace(/\"/g, "") +
                                            " is already included elsewhere - maybe recursion",
                                        s: e[g],
                                    };
                                ...
                                for (var S = u(E), P = 0; P < S[0].length; P++)
                                    (S[0][P].includedFile = h[0].replace(
                                        /\"/g,
                                        "",
                                    )),
                                        m.push(S[0][P]);
                                for (P in S[1]) f[P] = S[1][P];
                                r[h[0].replace(/\"/g, "")] = M;
                            }
                    } else {
                        if (c) {
            ...
            c = {},
            d = function (e, t) {
                for (var r = e.toString(16); r.length < t; ) r = "0" + r;
            ...
            C = function (e, t) {
                ...
                for (var o = 0; o < t.length; o++) (r += m(t[o])), (s += t[o]);
        ...
        return {
                    ...
                    try {
                        ...
                        if ("DB" === a.opcode || "FCB" === a.opcode) {
                            for (
                                ...
                                if (
                                    "number" !=
                                    typeof (t = Parser.evaluate(a.params[s], i))
                                )
                                    if ("string" != typeof t);
                                    else
                                        for (C = 0; C < t.length; C++)
                                            a.lens[r++] = t.charCodeAt(C);
                                else a.lens[r++] = Math.floor(t % 256);
                            continue;
                        }
                        if (".CSTR" === a.opcode) {
                            for (
                        ...
                        if (".ISTR" === a.opcode) {
                            for (
                                ...
                                else a.lens[r++] = Math.floor(t % 128);
                        ...
                        if (
                            (a.lens &&
                                a.lens[1] &&
                                "function" == typeof a.lens[1] &&
                                ("addr24" === a.lens[2]
                                    ? ((l = a.lens[1](i)),
                                      n
                                          ? ((a.lens[3] = Math.floor(l % 256)),
                                            (a.lens[2] = Math.floor(
                                                (l >> 8) % 256,
                                            )),
                                            (a.lens[1] = Math.floor(
                                        ...
                                        ? n
                                            ...
                                            : ((a.lens[2] =
                                              ...
                                              (a.lens[1] =
                                                  255 & l.charCodeAt(1)))
                                        : n
                                        ? ((a.lens[2] = Math.floor(l % 256)),
                                          (a.lens[1] = Math.floor(l / 256)))
                                        : ((a.lens[1] = Math.floor(l % 256)),
                                          (a.lens[2] = Math.floor(l / 256)))
                                    : ((l = a.lens[1](i)), (a.lens[1] = b(l)))),
                            a.lens &&
                                a.lens.length > 2 &&
                                "function" == typeof a.lens[2] &&
                                ((l = a.lens[2](i)),
                                null === a.lens[3]
                                    ? "string" == typeof (l = a.lens[2](i))
                                        ? n
                                            ? ((a.lens[2] =
                                                  255 & l.charCodeAt(0)),
                                              (a.lens[3] =
                            ...
                            a.lens &&
                                a.lens.length > 3 &&
                                "function" == typeof a.lens[3] &&
                                ((l = a.lens[3](i)),
                                null === a.lens[4]
                                    ? "string" == typeof (l = a.lens[3](i))
                                        ? n
                                            ? ((a.lens[3] =
                                                  255 & l.charCodeAt(0)),
                                              (a.lens[4] =
                            ...
                            if (
                                ("string" == typeof a.lens[1] &&
                                    (a.lens[1] = a.lens[1].charCodeAt(0)),
                                isNaN(a.lens[1]))
                            )
                                throw (
                                    (console.log(1201, a),
                            ...
                            if (
                                (a.lens[1] > 255 || a.lens[1] < -128) &&
                                2 == a.lens.length
                            )
                                throw {
                                    message:
                                        "param out of bounds - " + a.lens[1],
                                };
            ...
            lst: function (e, t, r, n, s) {
                ...
                for (var l = 0, p = e.length; l < p; l++) {
                    if (
                        ...
                        for (var u = 0; u < i.lens.length; u++)
                            o += m(i.lens[u]) + " ";
                    if (!n) for (; o.length < 20; ) o += " ";
                    if (n) for (; o.length < 15; ) o += " ";
                    if ((i.label && (o += i.label + ":   "), !n))
                        for (; o.length < 30; ) o += " ";
                    if (n) for (; o.length < 22; ) o += " ";
                ...
                for (var h in c)
                    if (
                        ...
                        for (o = "", o += h + ": "; o.length < 20; ) o += " ";
                        if (
                            ((o += g(c[h].value)),
                            (o += " DEFINED AT LINE " + c[h].defined.line),
                            "*main*" != c[h].defined.file &&
                                (o += " IN " + c[h].defined.file),
                            (a += o + "\n"),
                            c[h].usage)
                        )
                            for (p = 0; p < c[h].usage.length; p++)
                                (a +=
                                    "                    > USED AT LINE " +
                                    c[h].usage[p].line),
                                    "*main*" != c[h].usage[p].file &&
                                        (a += " IN " + c[h].usage[p].file),
                                    (a += "\n");
                    }
                return a;
            },
            html: function (e, t, r, n) {
                var s,
                    o,
                    i = "<html><head><meta charset=utf-8><body><table>";
                void 0 === n && (n = !1);
            ...
            hex: function (e, t) {
                for (
                    ...
                    if (
                        (".PRAGMA" === (r = e[p]).opcode &&
                            (2 == r.params.length &&
                                "HEXLEN" == r.params[0].toUpperCase() &&
                                ((l = parseInt(r.params[1])) < 1 || l > 64) &&
                                (l = 16),
                            1 == r.params.length &&
                                "SEGMENT" == r.params[0].toUpperCase() &&
                                (a = !0)),
                        !(
                            r.ifskip ||
                            (a && (t || (t = "CSEG"), r.segment != t))
                        ))
                    ) {
                        var h = r.addr;
                        if (
            ...
            */
                let newArray = [];
                for (
                    let counter = 0, length = inputArray.length;
                    counter < length;
                    counter++
                ) {
                    ...
                    if (tempObject.lens) {
                        for (
                            let innerCounter = 0;
                            innerCounter < tempObject.lens.length;
                            innerCounter++
                        ) {
...
var Parser = (function (e) {
        ...
        return (
            (n.prototype = {
                ...
                evaluate: function (e) {
                    ...
                    for (a = 0; a < i; a++) {
                        ...
                        if (l === I) o.push(s.number_);
                            ...
                            if (
                                ((s.index_ = s.index_.toUpperCase()),
                                "<" === s.index_[0])
                            )
                                s.index_.substr(1) in e &&
                                    o.push(e[s.index_.substr(1)] % 256);
                            else if (">" === s.index_[0])
                                s.index_.substr(1) in e &&
                                    o.push(
                                        Math.floor(e[s.index_.substr(1)] / 256),
                                    );
                            else if (s.index_ in e) o.push(e[s.index_]);
                            else {
                                if (!(s.index_ in this.functions))
                                    throw new Error(
                                        "undefined variable: " + s.index_,
                                    );
                            ...
                            if (l !== _) throw new Error("invalid Expression");
                            if (
                                ((t = o.pop()), !(n = o.pop()).apply || !n.call)
                            )
                                throw new Error(n + " is not a function");
                            "[object Array]" ==
                            Object.prototype.toString.call(t)
                                ? o.push(n.apply(void 0, t))
                                : o.push(n.call(void 0, t));
                        }
                    }
                    if (o.length > 1)
                    ...
                    for (l = 0; l < a; l++) {
                        ...
                        if (p === I) i.push(s.number_);
                            ...
                            if (
                                ...
                                s.index_.substr(1) in e &&
                                    (i.push(e[s.index_.substr(1)] % 256),
                            ...
                            if (p !== _) throw new Error("invalid Expression");
                            if (
                                ((t = i.pop()), !(n = i.pop()).apply || !n.call)
                            )
                                throw new Error(n + " is not a function");
                            "[object Array]" ==
                            Object.prototype.toString.call(t)
                                ? i.push(n.apply(void 0, t))
                                : i.push(n.call(void 0, t));
                        }
                    }
                    if (i.length > 1)
                        throw new Error("invalid Expression (parity)");
                ...
                variables: function () {
                    for (
                        var e = this.tokens.length, t = [], r = 0;
                        r < e;
                        r++
                    ) {
                        var n = this.tokens[r];
                        n.type_ === k &&
                            -1 == t.indexOf(n.index_) &&
                            t.push(n.index_);
                    }
                    return t;
                },
            ...
            (w.prototype = {
                ...
                addfunc: function (e, t, n) {
                    for (
                        ...
                        t.length > 0 && s.prio_ <= t[t.length - 1].prio_;
                ...
                isNumber: function () {
                    for (
                        var e = !1, t = "", r = 0, n = 10, s = this.pos;
                        this.pos < this.expression.length;

                    ) {
                        var o,
                            i = this.expression.charCodeAt(this.pos);
                        if (
                            !(
                                (i >= 48 && i <= 57) ||
                                46 === i ||
                        ...
                        if (
                            ...
                            (o = t),
                            "$" === t[0] &&
                                ((o = "0x" + t.substr(1)), (n = 16)),
                            ("x" !== t[1] && "X" !== t[1]) || (n = 16),
                            ("h" !== t[t.length - 1] &&
                                "H" !== t[t.length - 1]) ||
                                (10 != n && 2 != n) ||
                                ((o = "0x" + t.substr(0, t.length - 1)),
                                (n = 16)),
                            ("b" !== t[t.length - 1] &&
                                "B" !== t[t.length - 1]) ||
                                (10 == n &&
                                    ((o = t.substr(0, t.length - 1)), (n = 2))),
                            "%" === t[0])
                        ) {
                            if (t.length < 2) return (this.pos = s), !1;
                            (o = t.substr(1)), (n = 2);
                        }
                ...
                isString: function () {
                    ...
                    if (
                        ...
                        for (this.pos++; this.pos < this.expression.length; ) {
                            if (
                                this.expression.charAt(this.pos) == n &&
                                "\\" != t.slice(-1)
                            ) {
                                this.pos++,
    ...
    rle1Decode = function (e) {
        ...
        return (
            e.forEach(function (e) {
                if ("number" != typeof e)
                    for (var r = 0; r < e[0]; r++) t.push(e[1]);
                else t.push(e);
            }),
            t
        );
    ...
    makeSNA = function (e, t) {
        ...
        return (
            ASM.ENT &&
                ((r[7403] = 255 & ASM.ENT), (r[7404] = (ASM.ENT >> 8) & 255)),
            r
        );
    },
    ...
    tapdata = function (e, t) {
        var r,
            ...
            s = t;
        n[0] = t;
        for (var o = 0; o < e.length; o++) n.push(e[o]), (s = 255 & (s ^ e[o]));
        return (
            n.push(s), (r = n.length), n.unshift(r >> 8), n.unshift(255 & r), n
        );
    },
    ...
    makeTAP = function (e) {
        for (
            var t, r = null, n = 0, s = [], o = [], i = 0, a = 0, l = e.length;
            a < l;
            a++
        ) {
            var p = (t = e[a]).addr;
            if (
                ...
                void 0 !== p && 0 === n && (r = p),
                p != r + n &&
                    (n && (o = aconcat(o, makeTapBlock(r, s, i++))),
                    (r = p),
                    (n = 0),
                    (s = [])),
                t.lens)
            ) {
                for (var u = 0; u < t.lens.length; u++) s.push(t.lens[u]);
                n += t.lens.length;
            }
        }
