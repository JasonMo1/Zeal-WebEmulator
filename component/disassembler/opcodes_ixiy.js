...
const dd_fd_intructions = {
    ...
    0x36: {
        text: (thrd_op, forth_op) =>
            `LD (r+\$${hex8(thrd_op)}),\$${hex8(forth_op)}`,
        size: 4,
    },
    0x22: {
...
function opcode_DD_FD_CB_x(third, fourth) {
    switch (fourth) {
        case 0x06:
            return `RLC (r+\$${hex8(third)})`;
        case 0x0e:
            return `RRC (r+\$${hex8(third)})`;
        case 0x16:
            return `RL  (r+\$${hex8(third)})`;
        case 0x1e:
            return `RR  (r+\$${hex8(third)})`;
        case 0x26:
            return `SLA (r+\$${hex8(third)})`;
        case 0x2e:
            return `SRA (r+\$${hex8(third)})`;
        case 0x3e:
            return `SRL (r+\$${hex8(third)})`;
        default:
            if ((fourth & 0xc7) == 0x46) {
